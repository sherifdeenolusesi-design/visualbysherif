      ...
      <div className="max-w-5xl mx-auto px-4 py-20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-20">
          ...
          <div className="space-y-10">
            <div>
              <h3 className="text-zinc-400 text-sm uppercase tracking-widest mb-3">Email</h3>
              <a
            ...
            <div>
              <h3 className="text-zinc-400 text-sm uppercase tracking-widest mb-3">Based in</h3>
              <p className="text-white text-base">Birmingham, West Midlands</p>
            </div>
            <div>
              <h3 className="text-zinc-400 text-sm uppercase tracking-widest mb-3">Follow</h3>
              <div className="space-y-2.5">
                <a
                  href="https://instagram.com/visualbysherif"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center gap-2 text-white text-base hover:text-zinc-300 transition-colors group"
                >
                ...
                <a
                  href="https://tiktok.com/@visualbysherif"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center gap-2 text-white text-base hover:text-zinc-300 transition-colors group"
                >
                ...
                <a
                  href="https://facebook.com/visualbysherif"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center gap-2 text-white text-base hover:text-zinc-300 transition-colors group"
                >
            ...
            <div>
              <h3 className="text-zinc-400 text-sm uppercase tracking-widest mb-3">
                Response Time
              </h3>
